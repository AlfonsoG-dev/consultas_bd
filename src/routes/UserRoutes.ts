...
export class UserRoutes implements RoutesModel{
    ...
    get_by_name_route(): void {
        this.user_routes.get("/get-name/:name", this.controller.read_by_name.bind(this.controller))
    }
    get_by_email_route(): void {
        this.user_routes.get("/get-email/:email", this.controller.read_by_email.bind(this.controller))
    }
